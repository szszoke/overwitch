...
ow_resampler_reset_buffers (struct ow_resampler *resampler)
{
  ...
  resampler->o2h_bufsize =
    resampler->bufsize * resampler->o2h_frame_size;
  resampler->h2o_bufsize =
    resampler->bufsize * resampler->h2o_frame_size;
				    ...
				    unsigned int xfr_timeout, int quality)
{
  ...
  *resampler_ = resampler;
  ...
  resampler->o2h_frame_size = resampler->engine->device_desc.outputs * sizeof (float);
  resampler->h2o_frame_size = resampler->engine->device_desc.inputs * sizeof (float);
